<?php
/**
 * Flavor Theme - Search Form (M3 Search Bar style)
 */
?>
<form role="search" method="get" class="search-form md-search-bar" action="<?php echo esc_url( home_url( '/' ) ); ?>">
    ...
    <input type="search" class="md-search-bar__input" placeholder="<?php esc_attr_e( 'Search...', 'flavor' ); ?>" value="<?php echo get_search_query(); ?>" name="s" aria-label="<?php esc_attr_e( 'Search', 'flavor' ); ?>">
</form>
