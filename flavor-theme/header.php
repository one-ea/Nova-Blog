...
<header class="site-header" role="banner">
    <div class="app-bar">
        ...
        <!-- 桌面端水平导航 -->
        <nav class="app-bar__nav" aria-label="<?php esc_attr_e('主导航', 'flavor'); ?>">
            <?php
...
<nav class="nav-drawer" role="navigation" aria-label="<?php esc_attr_e('移动端导航', 'flavor'); ?>" aria-hidden="true">
