...
comment_form( [
    ...
    'fields' => [
        'author' => '<div class="comment-form-field mb-16"><label for="author" class="text-label-large">' . __( '姓名', 'flavor' ) . ' *</label><input id="author" name="author" type="text" class="md-text-field" required></div>',
        'email'  => '<div class="comment-form-field mb-16"><label for="email" class="text-label-large">' . __( '邮箱', 'flavor' ) . ' *</label><input id="email" name="email" type="email" class="md-text-field" required></div>',
        'url'    => '<div class="comment-form-field mb-16"><label for="url" class="text-label-large">' . __( '网站', 'flavor' ) . '</label><input id="url" name="url" type="url" class="md-text-field"></div>',
    ],
    'comment_field'  => '<div class="comment-form-field mb-16"><label for="comment" class="text-label-large">' . __( '评论', 'flavor' ) . ' *</label><textarea id="comment" name="comment" class="md-text-field" rows="5" required></textarea></div>',
